...
<head>
    ...
    <style>
        ...
        h2 { margin: 0 0 6px; color: #2c3e50; text-align: center; }
        ...
        .error { background: #f8d7da; color: #721c24; padding: 10px; border-radius: 4px; margin-bottom: 14px; font-size: 13px; }
        .success { background: #d4edda; color: #155724; padding: 10px; border-radius: 4px; margin-bottom: 14px; font-size: 13px; }
